...
// The Membership_typeFunc type is an adapter to allow the use of ordinary
// function as Membership_type mutator.
type Membership_typeFunc func(context.Context, *ent.MembershipTypeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f Membership_typeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.MembershipTypeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.MembershipTypeMutation", m)
}
...
func (f PersonnelFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PersonnelMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PersonnelMutation", m)
}

// The PersonnelRelCustomerFunc type is an adapter to allow the use of ordinary
// function as PersonnelRelCustomer mutator.
type PersonnelRelCustomerFunc func(context.Context, *ent.PersonnelRelCustomerMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PersonnelRelCustomerFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PersonnelRelCustomerMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PersonnelRelCustomerMutation", m)
}
